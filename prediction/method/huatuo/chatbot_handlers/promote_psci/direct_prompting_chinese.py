...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def print_info():
        print('This chatbot handler is for PSCI prediction on the PROMOTE dataset. It directly prompts using EHR information for LLM prediction.')
    ...
    def ret_prompt(self, response, label_list):
        ...
        for label in label_list:
            if "是" in response or "YES" in response or "Yes" in response:
                prediction.append(1)
