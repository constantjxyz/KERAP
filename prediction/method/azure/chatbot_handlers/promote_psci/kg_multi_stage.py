...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def prompt_chat(self, ehrdataset, sample_idx, print_conversation=False):
        ...
        if print_conversation == True:
            ...
            print("PSCI Response 1:", response_1)
            print("PSCI Response 2:", response_2)
    ...
    def print_info():
        print('This chatbot handler is for PSCI prediction on the PROMOTE dataset. It leverages KG information and multi-stage prompts on LLM prediction.')