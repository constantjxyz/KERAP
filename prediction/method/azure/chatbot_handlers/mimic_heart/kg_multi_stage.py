...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def print_info():
        print('This chatbot handler is for "Congestive heart failure; nonhypertensive" prediction on the MIMIC dataset. It leverages KG information and multi-stage prompts on LLM prediction.')
