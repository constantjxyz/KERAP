...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def print_info():
        print('This chatbot handler is for "Congestive Heart Failure (CHF) without hypertension"  prediction on the MIMIC dataset. It leverages chain-of-thought on LLM prediction.')
