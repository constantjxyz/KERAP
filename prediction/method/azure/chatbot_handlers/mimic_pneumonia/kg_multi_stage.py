...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def print_info():
        print('This chatbot handler is for "Pneumonia" prediction on the MIMIC dataset. It leverages kg information and multi-stage prompts on LLM prediction.')
