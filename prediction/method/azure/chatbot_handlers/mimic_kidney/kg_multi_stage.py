...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def print_info():
        print('This chatbot handler is for "chronic kidney disease" prediction on the MIMIC dataset. It leverages kg and multi-stage prompts on LLM prediction.')
