...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def prompt_chat(self, ehrdataset, sample_idx, print_conversation=False):
        ...
        KG_neg_prompt = "Check your prediction cautiously. Do not overestimate the probability of a patient unless certain provided standards are met. Please answer in the following format: Chronic kidney disease: <YES or NO>."
    ...
    def print_info():
        print('This chatbot handler is for "chronic kidney disease" prediction on the MIMIC dataset. It leverages multi-stage prompts on LLM prediction.')
