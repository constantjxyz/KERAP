...
class ChatBotHandler(BaseChatBotHandler):
    ...
    def print_info():
        print('This chatbot handler is for "Chronic kidney disease" prediction on the MIMIC dataset. It only uses EHR information for direct prompting on LLM prediction.')